...
<div id="app">
    ...
    <main class="container">
        <div class="hero-section">
            ...
            <p class="subtitle">Find your favorite anime and add them to your watchlist!</p>
        ...
        <div class="content-section">
            <h2 id="results-title" class="section-title">Search Results</h2>
            ...
            <div id="load-more" class="mt-4 text-center" style="display: none;">
...
<script src="{{ asset('js/pages/search_anime.js') }}"></script>
@endsection